...
//                iconvip.setLayoutParams(lp);
    ...
    @butterknife.OnClick({R.id.my_updata, R.id.btnLogout, R.id.imagetouxiang, R.id.myhuiyuan, R.id.pay, R.id.mycomment, R.id.wingift, R.id.winguaidou, R.id.rechargeguaidou, R.id.login, R.id.mobile, R.id.aboutus, R.id.nologin, R.id.house})
