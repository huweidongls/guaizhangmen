...
public class DownloadService extends Service {
    ...
    private void download() {
        ...
        DownloadUtil.get().download("http://abv.cn/music/红豆.mp3", "/com.99zan/download/yp", new DownloadUtil.OnDownloadListener() {
            @Override
    ...
    private void putIntoSqlite(JSONObject jsonObject, JSONObject zhangjie) {
        ...
        cv1.put("zhangjiePath", Environment.getExternalStorageDirectory()+"/com.99zan/download/yp/"+"红豆.mp3");
