...
public abstract class VideoPlayerController
    ...
    protected VVideoPlayer mNiceVideoPlayer;
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        L.d(mNiceVideoPlayer.isIdle()+"");
        L.d(mNiceVideoPlayer.isError()+"");
        L.d(mNiceVideoPlayer.isPreparing()+"");
        L.d(mNiceVideoPlayer.isPrepared()+"");
        L.d(mNiceVideoPlayer.isCompleted()+"");
