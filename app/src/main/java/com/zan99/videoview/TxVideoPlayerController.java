...
//        mLength.setText(Util.formatTime(length));
    ...
    @Override
    public void setNiceVideoPlayer(VVideoPlayer niceVideoPlayer) {
...
//                RelativeLayout.LayoutParams lpview = (RelativeLayout.LayoutParams) mImage.getLayoutParams();
//                int width = lpview.width;
//                int height = lpview.height;
//                RelativeLayout parent = (RelativeLayout) mImage.getParent();
